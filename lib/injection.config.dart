...
import 'features/calendar/domain/usecases/get_events.dart' as _i14;
import 'features/calendar/domain/usecases/get_events_day.dart' as _i15;
import 'features/calendar/domain/usecases/get_events_month.dart' as _i16;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i14.GetEvents>(
      () => _i14.GetEvents(get<_i11.CalendarRepository>()));
  gh.lazySingleton<_i15.GetEventsOfDay>(
      () => _i15.GetEventsOfDay(get<_i11.CalendarRepository>()));
  gh.lazySingleton<_i16.GetEventsOfMonth>(
      () => _i16.GetEventsOfMonth(get<_i11.CalendarRepository>()));
  ...
  gh.factory<_i19.CalendarBloc>(() => _i19.CalendarBloc(
      getCalendarEntry: get<_i14.GetEvents>(),
