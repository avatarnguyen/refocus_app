...
import 'core/injectable_module.dart' as _i21;
...
import 'features/calendar/domain/usecases/add_event.dart' as _i19;
...
import 'features/calendar/domain/usecases/get_events_day.dart' as _i16;
import 'features/calendar/domain/usecases/get_events_month.dart' as _i17;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i16.GetEventsOfDay>(
      () => _i16.GetEventsOfDay(get<_i11.CalendarRepository>()));
  gh.lazySingleton<_i17.GetEventsOfMonth>(
      () => _i17.GetEventsOfMonth(get<_i11.CalendarRepository>()));
  gh.lazySingleton<_i18.UpdateEvent>(
      () => _i18.UpdateEvent(repository: get<_i11.CalendarRepository>()));
  gh.lazySingleton<_i19.AddEvent>(
      () => _i19.AddEvent(repository: get<_i11.CalendarRepository>()));
  gh.factory<_i20.CalendarBloc>(() => _i20.CalendarBloc(
      getCalendarEntry: get<_i15.GetEvents>(),
      addEvent: get<_i19.AddEvent>(),
      deleteEvent: get<_i13.DeleteEvent>(),
      updateEvent: get<_i18.UpdateEvent>()));
